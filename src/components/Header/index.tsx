...
export default function Header() {
  ...
  return (
    <header className="bg-zinc-900">
      ...
      <hr className="h-px border-t-0 bg-gray-100 opacity-10 dark:opacity-10" />
      <Dialog
        open={mobileMenuOpen}
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  <DisclosureButton className="group flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-gray-50 hover:bg-gray-50">
                    Product
                    <ChevronDownIcon
                      aria-hidden="true"
