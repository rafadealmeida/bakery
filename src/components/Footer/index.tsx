    ...
    <footer className="w-full bg-zinc-900 ">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-8 py-10 ">
          <div className="mb-10 2xl:col-span-2 lg:mb-0 flex items-center flex-col 2xl:items-start">
            <div className="flex">
              <a href="#" className="-m-1.5 p-1.5 mb-4">
            ...
            <div className="flex items-center justify-between w-full max-w-xl mx-auto flex-col  2xl:flex-col 2xl:items-start">
              <p className="text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">
                A bakery is an estoblishment that produces and sells flour-
                based food baked in an oven such as bread, cooides, cakes,
                doughnuts, bogels, pastries, and pies. 3a Arington Street,
                Boston, MA o2n16 Call: 888-990-0000 Email: hello@workoutdemo.com
              </p>
            </div>
          </div>
          <div className="lg:mx-auto text-left uppercase">
            <h4 className="text-lg text-gray-100 font-medium mb-7">
              Import Links
            </h4>
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-gray-500 ">
              ©<a href="javascript:;">Bakery</a> 2024, All rights reserved.
            </span>
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
              <a
                href="javascript:;"
                className="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-200"
              >
                <svg
